...
def details():
    if request.method == "GET":
        if 'ju' in request.args:
            ...
            url = unquote(i)
            data = get_details(
                'https://www.indeed.com/viewjob?cmp=Partech&t=Firmware+Developer&jk=b925a17f21aaf1fe&sjdu=QwrRXKrqZ3CNX5W-O9jEvbCKnmXEzLyMBrs3gIHlNWvJbQpQHi5BoRvr8e22IUJUpvoV9mAYHLyXl8MR08Y-XQ&adid=312389480&ad=-6NYlbfkN0Cq2a5lNafOK06dKo-7gXGxOSr25-80nMAj1uySNMa9z3ZPhdc3Ln2Kdy5h4SJN6YGCSpkYB1ZryPXuYumXTrZcZ-GSVckAZnDkRG0WUCkT94VV0f1Uy3YVjDlXPBnodAVlTl9pER0ZLBvd1bzQhKbLGO683rptijIKK15_phakk8z4jpThonc12IsSrn3dxz2mIkRxjEfYOR0crRhl5Rl9fqwzVHpWfOv9vEiCLNhC2risj2lszTAtwhI-gtUI8bLgO0322ltTM_hWhw3AbCTnbdysQps2IgBnOLzdJyh1PLXuZ1_B8DNXXHQKP1cmONU%3D&pub=4a1b367933fd867b19b072952f68dceb&vjs=3')
            return data
        else:
